...
export const metadata = { title: "Ekip Üyeleri" };
...
export default async function EkipUyeleriPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Ekip Üyeleri</h1>
          <p className="text-sm text-muted-foreground">
            Toplam {kullanicilar.length} ekip üyesi · Ekleme, şifre sıfırlama ve
            ...
            {kullanicilar.length === 0 && (
              <TableRow>
                <TableCell colSpan={6} className="h-24 text-center text-muted-foreground">
                  Henüz ekip üyesi yok. Sağ üstten yeni üye ekleyin.
                </TableCell>
              </TableRow>
            )}
            {kullanicilar.map((k) => (
